...
<div class="row white container description description-upside s12">
        ...
        <div class="row container">
            ...
            <div class="col m12 s12">
                <h5 class="col s12 orange-text darken-3" id="question"><strong> {{ $dadoscurso->question }} </h5>
            </div><br>
        ...
        <div class="row container">
            ...
            <div class="white">
                <ul class="collapsible">
                    ...
                    <li>
                        <div class="collapsible-header"><i class="material-icons">expand_more</i> {{ $dadosgrade->title }}</div>
