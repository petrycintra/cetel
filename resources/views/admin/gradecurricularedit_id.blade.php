...
<div class="row white container description description-upside s12">
        ...
        <form action="{{ Route('cursopresencialedit_update') }}" method="POST">
            ...
            @foreach ($gradecurricular as $dadoscurso)
        ...
        <div class="row container">
            ...
            <div class="input-field col s12 m12">
                ...
                <input id="question" name="question" type="text" class="validate" value="{{ $dadoscurso->title }}">
        ...
        <div class="row container center">
            <button type="submit" class="btn blue darken-4"> ATUALIZAR GRADE </button>
